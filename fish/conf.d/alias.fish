...
alias proxy='set -gx http_proxy http://proxy.internal:5451; set -gx https_proxy $http_proxy; set -gx all_proxy $http_proxy; set -gx HTTP_PROXY $http_proxy; set -gx HTTPS_PROXY $https_proxy;'
